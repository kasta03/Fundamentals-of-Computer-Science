...
void count(int *tab, int n) {
  ...
  printf(" Liczba zerowych elementów: %d\n", count);
}
...
int main() 
{
  ...
  int a = sizeof(tab1) / sizeof(tab1[0]);
  int b = sizeof(tab2) / sizeof(tab2[0]);
  printf("Liczba elementów tab1: %d\n", a);
  count(tab1, a);
  printf("Liczba elementów tab2: %d\n", b);
  count(tab2, b);
  return 0;
}